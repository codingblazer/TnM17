...
import com.example.sachinaggarwal.tnm17.ParallaxViewPager.SampleListFragment2;
 ...
 */
public class Events extends FragmentActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener {
    ...
    public class PagerAdapter extends FragmentPagerAdapter {
        ...
        private final String[] TITLES = {"DANCE", "DRAMA", "MUSIC","QUIZZING","MISC","ORATORY","ART","LITERATURE"};
        ...
        public Fragment getItem(int position) {
            ScrollTabHolderFragment fragment = (ScrollTabHolderFragment) SampleListFragment2.newInstance(position);
